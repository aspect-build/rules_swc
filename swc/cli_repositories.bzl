"@generated by @aspect_rules_js//npm/private:npm_translate_lock.bzl from @aspect_rules_swc//swc:pnpm-lock.yaml"

load("@aspect_rules_js//npm:npm_import.bzl", "npm_import")

def npm_repositories():
    "Generated npm_import repository rules corresponding to npm packages in @aspect_rules_swc//swc:pnpm-lock.yaml"
    npm_import(
